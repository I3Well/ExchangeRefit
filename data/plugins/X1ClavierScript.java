...
public class X1ClavierScript implements EveryFrameScript {
    ...
    public void advance(float amount) {
        ...
        if (originalPlugin == null || originalPlugin instanceof X1TerminalMenu) return;
        ...
        if (options != null) {
            ...
            if (pluginClass.contains("barcmd") || pluginClass.contains("combat") || 
                pluginClass.contains("core_refit") || pluginClass.contains("fleet") ||
            ...
            if (cible != null && cible.getMarket() != null) {
                ...
                String boutonTexte = fr ? "Pour accéder au Terminal ExchangeRefit, appuyez sur [X]" : "For access to ExchangeRefit Terminal, press [X]";

                if (!options.hasOption("TERMINAL_EXCHANGE_REFIT")) {
                    options.addOption(boutonTexte, "TERMINAL_EXCHANGE_REFIT");
                }
