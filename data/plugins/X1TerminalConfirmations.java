...
public class X1TerminalConfirmations {
    ...
    public static void afficherPreviewPasteDefault(X1TerminalMenu menu) {
        menu.options.clearOptions();
        menu.textPanel.addParagraph("=== REFIT COMMAND PREVIEW (DEFAULT PASTE) ===", Color.GREEN);
        ...
        menu.textPanel.addParagraph(" • Reassign Advanced Gunnery Control (AGC): YES", Color.GREEN);
    ...
    public static void afficherPreviewPasteFiltered(X1TerminalMenu menu) {
        menu.options.clearOptions();
        menu.textPanel.addParagraph("=== REFIT COMMAND PREVIEW (CUSTOM SETUP) ===", Color.GREEN);
        ...
        menu.textPanel.addParagraph(" • Reassign Advanced Gunnery Control (AGC): " + (menu.filterTags ? "YES" : "NO"), menu.filterTags ? Color.GREEN : Color.RED);
