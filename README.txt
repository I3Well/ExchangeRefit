...
Author: I3Well (Original concept by Anjasnare)
...
directly from the campaign space map. It allows captains to scan, duplicate, 
archive, and selectively paste complete ship loadouts using resources from 
the fleet cargo and can reattribute s_mods. 
...
2. KEY FEATURES
-------------------------------------------------------------------------------
* Space Hotkey: Press [K] while flying in open space to open the ExchangeRefit 
  Terminal immediately (conﬁned area, won't interfere with station sub-menus).
...
-------------------------------------------------------------------------------
5. CHANGELOG & STABILITY (v1.4.1)
-------------------------------------------------------------------------------
* [v1.4.1] Moved terminal access to open space map via [K] hotkey to fully 
  resolve option panel destruction bugs and eliminate UI sub-menu crashes.
